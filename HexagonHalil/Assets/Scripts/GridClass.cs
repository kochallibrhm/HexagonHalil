...
// This class includes all constants that we need for game. And we extended other classes from this class for be able to use that constants easily.
...
public class GridClass : MonoBehaviour {
	...
	protected readonly Vector2 HEX_START_POSITION = new Vector3(0f, 3f, 0f);
}
